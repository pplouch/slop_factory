...
## - State (see scripts/units/blob/states/): `current_state` holds one of
...
## - Factory (scripts/autoload/effects.gd): all particle/floating-text/marker
##   creation is delegated to the Effects autoload instead of instantiating
##   scenes by hand here.
## - Inheritance (scripts/core/combatant.gd): health/damage/regen math lives once
...
## The active State-pattern object; see scripts/units/blob/states/blob_state.gd.
